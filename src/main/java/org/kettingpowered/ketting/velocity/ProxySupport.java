...
/**
 * Based on Paper's velocity support patches
 */
public final class ProxySupport {
    ...
    public static boolean checkIntegrity(final FriendlyByteBuf buf) {
        ...
        try {
            ...
            mac.init(new SecretKeySpec(KettingConfig.getInstance().VELOCITY_FORWARDING_SECRET.getValue().getBytes(java.nio.charset.StandardCharsets.UTF_8), "HmacSHA256"));
